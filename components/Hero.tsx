      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex justify-start">
          <Image
            ...
            width={350}
            height={400}
            className="w-full max-w-xs md:max-w-md h-auto rotate-90"
            priority
          />
        </div>
        {/* Textos e estatísticas à direita */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-16">
          ...
          <div className="flex gap-10 justify-center md:justify-start">
            ...
            <div className="text-center">
              ...
              <div className="text-blue-100 text-sm">Veículos Atendidos</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-yellow-400 mb-1">
                98%
